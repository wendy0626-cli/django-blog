...
#  邮箱配置
EMAIL_USE_SSL = True
EMAIL_HOST = 'smtp.qq.com'  # 我这里使用的是163邮箱，可以配置其他
EMAIL_PORT = 465
EMAIL_HOST_USER = '1558365217@qq.com'  # 邮箱帐号：用于发送邮件的账号
EMAIL_HOST_PASSWORD = 'xxxxxxxxxxxxxxxx'  # 邮箱密码：用于发送邮件的账号密码
DEFAULT_FROM_EMAIL = 'bgods_blog <1558365217@qq.com>'  # 发件人，邮件头部显示
